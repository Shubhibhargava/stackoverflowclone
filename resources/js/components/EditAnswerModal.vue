      ...
      <div class="modal-wrapper">
       ...
       <form autocomplete="off" @submit.prevent="update" v-if="!success" method="post">
             <div class="form-group" v-bind:class="{ 'has-error': error && errors.name }">
                <label for="name" class="lab">Answer</label>
                <input type="text" id="name" class="form-control" v-model="questions.answer" required>
...
export default {
    ...
    methods: {
       ...
       update(){
                 var app = this
                this.$http({
                     url: `updateanswer/`+this.$route.params.id,
                    method: 'POST',
                    data: {
