      ...
      <div class="modal-wrapper">
          ...
          <div class="modal-body">
            <div class="row" v-if="status == 'success'">
               ...
               <div class="alert alert-success">
                  <p>Tag info updated successfully</p>
              </div>
                </div></div>
            <slot name="body">
              <div class="row">
       ...
       <form autocomplete="off" @submit.prevent="update" v-if="!success" method="post">
             <div class="form-group" v-bind:class="{ 'has-error': error && errors.name }">
                ...
                <input type="text" id="name" class="form-control" v-model="tags.name" required>
                
            </div>
            <div class="form-group" v-bind:class="{ 'has-error': error && errors.email }">
                <label for="email" class="lab">Description</label>
                <textarea id="email" class="form-control textarea"  v-model="tags.description" required></textarea>
    ...
    methods: {
      getUsers() {
       ...
       update(){
                 var app = this
                this.$http({
                     url: `updatetag/`+this.$route.params.id,
                    method: 'POST',
                    data: {
                       name:this.tags.name,
